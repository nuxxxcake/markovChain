function generateMarkovDict(words, chainDepth = 2) {
  const dict = {};
...
function markovSentence(dict, depth = 8) {
  let res = '';
...
const sentence = 'Артем любит морковь утром, а также Артем любит морковь вечером';

console.log(
  markovSentence(generateMarkovDict(sentence.split(' ')), 4)
);